<template>
  <header
    class="section center flex items-start flex-row justify-between md:items-center md:flex-col pb-[10rem] md:pb-[0rem] md:overflow-hidden"
  >
    <div class="h-full max-h-[37rem] flex flex-col justify-center mb-[6rem]">
      ...
      <h2 class="subtitle-big text-gray mb-[5.3rem]">
